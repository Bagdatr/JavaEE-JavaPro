...
<div class="container">
    ...
    <div class="row">
        <form action="/add-user" method="post">
            ...
            <div class="form-group">
                <label class="form-label">Do you have email?</label>
                <input class="form-control" type="email" name="user-email">
            </div>
            <div class="form-group">
                <label class="form-label">Input your password</label>
                <input class="form-control" type="password" name="user-password">
            </div>
            <div class="form-group">
                <label class="form-label">Retype your password</label>
                <input class="form-control" type="password" name="user-re-password">
            </div>
            <br>
